  ...
  const prizes = [
    {
      ...
      extras: ["Winner Certificate", "Cash Prize", "Internship Opportunities"]
    },
    {
      position: "2nd Place",
      amount: "₹5,000",
      ...
      extras: ["Runner-up Certificate", "Cash Prize", "Networking Opportunities"]
    },
    {
      position: "3rd Place",
      amount: "₹3,000",
      ...
      extras: ["3rd Place Certificate", "Cash Prize", "Career advantage"]
    }
  ];
