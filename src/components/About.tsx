      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="bg-black rounded-2xl sm:rounded-3xl p-6 sm:p-8 lg:p-12">
          <div className="grid lg:grid-cols-2 gap-8 sm:gap-12 items-center">
            <div>
              <h3 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-4 sm:mb-6 text-center lg:text-left">
              ...
              <ul className="space-y-3 sm:space-y-4 text-white">
                <li className="flex items-start space-x-3">
                  ...
                  <span className="text-sm sm:text-base">Network with industry professionals and like-minded developers</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-sm sm:text-base">Access to mentorship from experienced developers and entrepreneurs</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-sm sm:text-base">Work on cutting-edge problem statements from industry partners</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-sm sm:text-base">Free food, beverages, and swag throughout the event</span>
                </li>
                <li className="flex items-start space-x-3">
                  <div className="w-2 h-2 bg-orange-500 rounded-full mt-2 flex-shrink-0"></div>
                  <span className="text-sm sm:text-base">Certificate of participation and winner recognition</span>
                </li>
              </ul>
            </div>
              ...
              <div className="text-center">
                ...
                <div className="space-y-2 sm:space-y-3 text-white text-left">
                  ...
                  <div className="flex justify-between text-sm sm:text-base">
                    ...
                    <span className="text-orange-500 font-semibold">5 Available</span>
                  </div>
                </div>
              </div>
            </div>
